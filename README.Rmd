...
1. Scrape archived data with the `readr` package in [`01_read_inputs.R`](code/01_read_inputs.R)
1. Format data with the `dplyr` package in [`02_format_inputs.R`](code/02_format_inputs.R)
1. Compare predictive methods with the `tidyr` package in [`03_compare_methods.R`](code/03_compare_methods.R)
1. Create visualizations with the `ggplot2` package in [`04_explore_viz.R`](code/04_explore_viz.R)
1. Run statistical tests with the `stats` package in [`05_analyze_stat.R`](code/05_analyze_stat.R)
