...
[`/code/03_model_format.R`][./code/03_model_format.R]
...
Market data is formatted with the code in
[/code/04_market_format.R][./code/04_market_format.R]
...
Final tidy joined data is combined and formatted with the code in 
[`/code/06_compare_format.R`][/code/06_compare_format.R]
...
Code to generate exploratory plots can be found in 
[`/code/09_explore_plots.R`][/code/09_explore_plots]

```{r plots, echo=FALSE, message=FALSE, warning=FALSE}
model <- read_csv("./output/model.csv")
markets <- read_csv("./output/markets.csv")
polling_data <- read_csv("./output/polling_data.csv")
