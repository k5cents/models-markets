...
All public input data has been saved on the [internet archive][02] and can be accessed through their
wayback machine.
...
To achieve this, [Silver explains][06] that most models (**1**) "take lots of polls, perform various
...
[PredictIt][12] is an exchange run by [Victoria University][13] of Wellington, New Zealand. The site
...
These predictions are compared against the election results to evaluate the two methods.
