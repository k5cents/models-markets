...
In [the word's][08] of Nate Silver, FiveThirty's founder and primary author of
their model:
...
other factors in some unknownn way. [FiveThirtyEight rates pollsters][09] to
...
revelant market data as a `.csv` file.
