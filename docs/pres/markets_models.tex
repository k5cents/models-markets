...
\KeywordTok{if_else}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\StringTok{"re-elected"}\NormalTok{),}
        \DataTypeTok{true =} \KeywordTok{word}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\DecValTok{3}\NormalTok{),}
        \DataTypeTok{false =} 
  \KeywordTok{if_else}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\StringTok{"at-large"}\NormalTok{),}
          \DataTypeTok{true =} \KeywordTok{paste}\NormalTok{(}\KeywordTok{word}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\DecValTok{5}\NormalTok{), }\StringTok{"01"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{"-"}\NormalTok{),}
          \DataTypeTok{false =} 
    \KeywordTok{if_else}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\StringTok{"special"}\NormalTok{),}
            \DataTypeTok{true =} \KeywordTok{paste}\NormalTok{(}\KeywordTok{word}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\DecValTok{5}\NormalTok{), }\StringTok{"98"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{"-"}\NormalTok{),}
            \DataTypeTok{false =} 
      \KeywordTok{if_else}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\StringTok{"Senate"}\NormalTok{),}
              \DataTypeTok{true =} \KeywordTok{paste}\NormalTok{(}\KeywordTok{word}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\DecValTok{5}\NormalTok{), }\StringTok{"99"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{"-"}\NormalTok{),}
              \DataTypeTok{false =} 
        \KeywordTok{if_else}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\StringTok{"re-elected"}\NormalTok{),}
                \DataTypeTok{true =} \KeywordTok{word}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\DecValTok{3}\NormalTok{),}
                \DataTypeTok{false =} 
          \KeywordTok{if_else}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\StringTok{"Which party"}\NormalTok{),}
                  \DataTypeTok{true =} \KeywordTok{word}\NormalTok{(market_history}\OperatorTok{$}\NormalTok{code, }\DecValTok{5}\NormalTok{), }\StringTok{"ERROR"}\NormalTok{))))))}
\end{Highlighting}
\end{Shaded}
